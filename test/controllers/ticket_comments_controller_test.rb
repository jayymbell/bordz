...
class TicketCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket_comment" do
    assert_difference('TicketComment.count') do
      post ticket_comments_url, params: { ticket_comment: { comment: @ticket_comment.comment, created_by: @ticket_comment.created_by, ticket_id: @ticket_comment.ticket_id } }
    end
  ...
  test "should update ticket_comment" do
    patch ticket_comment_url(@ticket_comment), params: { ticket_comment: { comment: @ticket_comment.comment, created_by: @ticket_comment.created_by, ticket_id: @ticket_comment.ticket_id } }
